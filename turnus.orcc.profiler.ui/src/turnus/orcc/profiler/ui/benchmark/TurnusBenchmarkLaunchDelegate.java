...
public class TurnusBenchmarkLaunchDelegate implements ILaunchConfigurationDelegate {
	...
	public void launch(ILaunchConfiguration launchConfiguration, String mode, ILaunch launch, IProgressMonitor monitor)
		...
		try {
			...
			// configure process
			launch.addProcess(new TurnusProcess("benchmark", job, launch));
