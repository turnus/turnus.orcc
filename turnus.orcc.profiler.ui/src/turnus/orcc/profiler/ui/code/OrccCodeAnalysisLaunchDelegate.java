 ...
 * 
 */
package turnus.orcc.profiler.ui.code;
...
import turnus.orcc.profiler.code.OrccCodeAnalysis;
import turnus.ui.util.EclipseUtils;

/**
 * This class contains the {@link ILaunchConfigurationDelegate} for the
 * {@link OrccCodeAnalysis}
 * 
 * @author Simone Casale Brunet
 *
 */
public class OrccCodeAnalysisLaunchDelegate implements ILaunchConfigurationDelegate {

	@Override
	public void launch(ILaunchConfiguration launchConfiguration, String mode, ILaunch launch, IProgressMonitor monitor)
			throws CoreException {
		try {
			monitor.subTask("Turnus Code Analysis");
			...
			Job job = new Job("TURNUS Orcc Code Profiler") {
				...
				private OrccCodeAnalysis profiler;
			...
			// configure process
			launch.addProcess(new TurnusProcess("code analysis", job, launch));
